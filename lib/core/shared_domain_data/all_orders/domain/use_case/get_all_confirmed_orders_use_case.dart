...
class GetAllConfirmedOrdersUseCase
    extends StreamUseCase<List<OrderEntity>, void> {
  final AllOrdersRepo _ordersRepo;

  GetAllConfirmedOrdersUseCase(this._ordersRepo);

  @override
  Stream<Result<List<OrderEntity>>> call(void param) {
    return _ordersRepo.getAllConfirmedOrders();
  }
}
