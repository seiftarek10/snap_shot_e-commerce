...
class ConfirmOrderUseCase extends FutureUseCase<void, OrderEntity> {
  final OwnerOrderManagementRepo _managementRepo;

  ConfirmOrderUseCase(this._managementRepo);
  @override
  Future<Result<void>> call(OrderEntity param) async {
    return await _managementRepo.confirmOrder(order: param);
  }
}
