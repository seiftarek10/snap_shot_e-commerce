...
class DeleteConfirmedOrderUseCase extends FutureUseCase<void, OrderEntity> {
  final OwnerOrderManagementRepo _managementRepo;

  DeleteConfirmedOrderUseCase(this._managementRepo);
  @override
  Future<Result<void>> call(OrderEntity param) async {
    return await _managementRepo.deleteConfirmedOrder(order: param);
  }
}
